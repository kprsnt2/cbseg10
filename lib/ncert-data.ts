...
export const subjects: Subject[] = [
    ...
    },
    {
        ...
        books: [
            {
                bookName: 'Part A: Employability Skills',
                chapters: [
                    { id: 'ai-emp-1', name: 'Communication Skills', keyTopics: ['Verbal & Non-Verbal', 'Feedback', 'Barriers to Communication'] },
                    { id: 'ai-emp-2', name: 'Self-Management Skills', keyTopics: ['Stress Management', 'Self-Awareness', 'Self-Motivation'] },
                    { id: 'ai-emp-3', name: 'ICT Skills', keyTopics: ['Operating Systems', 'File Management', 'Computer Care'] },
                    { id: 'ai-emp-4', name: 'Entrepreneurial Skills', keyTopics: ['Characteristics of Entrepreneur', 'Role of Entrepreneurship', 'Myths'] },
                    { id: 'ai-emp-5', name: 'Green Skills', keyTopics: ['Sustainable Development', 'Green Economy', 'Role of Individuals'] },
                ],
            },
            {
                bookName: 'Part B: Subject Specific Skills',
                chapters: [
                    { id: 'ai-sub-1', name: 'Introduction to AI', keyTopics: ['AI Domains (Data, CV, NLP)', 'AI Ethics', 'AI Bias'] },
                    { id: 'ai-sub-2', name: 'AI Project Cycle', keyTopics: ['Problem Scoping', 'Data Acquisition', 'Data Exploration', 'Modelling', 'Evaluation'] },
                    { id: 'ai-sub-3', name: 'Neural Networks', keyTopics: ['Human vs Artificial Neural Network', 'Layers', 'Training'] },
                    { id: 'ai-sub-4', name: 'Data Science', keyTopics: ['Data Collection', 'Data Visualisation', 'Statistical Data'] },
                    { id: 'ai-sub-5', name: 'Computer Vision', keyTopics: ['Pixels', 'Convolution', 'OpenCV', 'Applications'] },
                    { id: 'ai-sub-6', name: 'Natural Language Processing', keyTopics: ['Chatbots', 'Bag of Words', 'TF-IDF', 'Text Normalisation'] },
                    { id: 'ai-sub-7', name: 'Evaluation', keyTopics: ['Confusion Matrix', 'Accuracy', 'Precision', 'Recall', 'F1 Score'] },
                ],
            },
        ],
    },
